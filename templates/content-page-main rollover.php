...
<div class="uk-grid-match hero-grid uk-child-width-1-2@s" uk-grid>
    <div class="">
        <div class="uk-card uk-card-secondary uk-padding-large uk-padding-remove-left uk-padding-remove-right uk-overflow-hidden"><h1 class=" uk-text-uppercase uk-card-header">TALK</h1> 
        	<div class="uk-card-body  uk-padding-remove-top uk-padding-remove-bottom">
        		<ul class="uk-grid-match icon-grid uk-child-width-1-2  uk-child-width-1-4@s" uk-grid>
        			...
        			<li class="icon-mates uk-visible-toggle" >
						...
						<div class="icon-title"><h5 class="icon-title uk-text-uppercase uk-text-center">Mates</h5></div>
						   <div class="rollover uk-hidden-hover uk-position-absolute uk-background-default uk-padding-small uk-padding-remove-top uk-padding-remove-bottom"><h4 class="" >How to Help?<br /><a href="#readmore">Check these</a></h4></div>
					</li>
        			...
        			<li class="icon-helpline uk-visible-toggle">
					     ...
					     <div class="rollover uk-hidden-hover uk-position-absolute uk-background-default uk-padding-small uk-padding-remove-top uk-padding-remove-bottom"><h4 class="" >5pm-Midnight <a href="tel:03002225717">0300 222 5717</a><br />Free + Confidential</h4></div>
					 </li>
